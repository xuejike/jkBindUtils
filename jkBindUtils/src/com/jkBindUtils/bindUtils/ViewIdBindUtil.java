...
public class ViewIdBindUtil<T> extends AbsBindUtil<T> {
    ...
    protected void readAnnotationView() {
        if (layout == 0) {
            layout = ReflectUtil.readBindViewLayout(dataClass);
        }
    }
...
//        SimpleAdapter
        ...
        List<Field> fields = ReflectUtil.getAllFields(dataClass);
        for (Field field : fields) {
            ...
            if(disregard == null){
                ...
                if (annotation != null){
                    ...
                    Method method = ReflectUtil.getGetterMethodByField(field.getName(), dataClass);
    ...
    protected void fillData2View(T data, View view) {
        ...
        for (Method method : methods) {
            Object d = ReflectUtil.invokeMethod(method, data);
